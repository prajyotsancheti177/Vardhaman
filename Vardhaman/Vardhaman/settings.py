...
SECRET_KEY = 'django-insecure-znaco8ec4r^awa1@r1&qo+jwgr@v+902q(__&hd$ov-!)8@so0'
...
CORS_ALLOWED_ORIGINS = [
    'http://localhost:5173',  # Allow requests from your React application
...
LOGGING = {
    ...
    'loggers': {
        ...
        # Add your custom logger for your application
        'calculator': {
            'handlers': ['file'],
            'level': 'DEBUG',
            'propagate': True,
